...
#ifdef MFEM_USE_CUDA
#ifdef MFEM_TRACK_CUDA_MEM
  mfem::out << "CuMemcpyHtoD(): copying " << bytes << " bytes from " << src
            << " to " << dst << " ... " << std::flush;
#endif
...
#ifdef MFEM_USE_CUDA
#ifdef MFEM_TRACK_CUDA_MEM
  mfem::out << "CuMemcpyDtoD(): copying " << bytes << " bytes from " << src
            << " to " << dst << " ... " << std::flush;
#endif
...
#ifdef MFEM_USE_CUDA
#ifdef MFEM_TRACK_CUDA_MEM
  mfem::out << "CuMemcpyDtoH(): copying " << bytes << " bytes from " << src
            << " to " << dst << " ... " << std::flush;
#endif
